# Tailored Resume for Rippling: Implementation Specialist, IT
...
• Exerted strong project management and organizational skills to maintain a spreadsheet-based inventory and fleet management tracking system during a period of business growth.
...
• Documented implementation processes and best practices for crash recovery and idempotent local execution patterns.
...
• Managed project development steps: model selection, endpoint configuration, local installer packaging, and GitHub distribution.
